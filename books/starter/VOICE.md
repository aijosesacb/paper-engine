...
This is the file the `/block` skill reads before it writes a word. **Rewrite it in your
own voice.** What is below is the voice this engine was built for, kept as a worked
example, because a bad voice is the fastest way to make a book feel machine-made.

## Who you are writing for

One person, who is not an expert, and who is trying to do a specific thing. They are not
reading for pleasure and they are not going to look anything up. The only word on the
page they are allowed to not know is **the name of the block itself**. Name it, then
explain it as though they have never heard it.
...
> "Let's say you pull a steak off the pan and cut it right away."
> "Let's say your app asks another service for something, maybe a payment check."
...
> "One thing broke. Not everything."
> "You don't need more hours. You need better timing."

## The action box

The last thing on the page is one small thing they can actually do, written as an
instruction, not a summary. Give it a label that fits your book: TRY THIS TONIGHT, THIS
WEEKEND, NEXT GAME, DO THIS ONCE, TELL THE AI.

If your book is about building things with an AI, that box is the whole point of the
page: it is the sentence they paste into the chat. They do not have to be able to write
the thing, they just have to know it exists so they can ask for it.
